...
const shell = (title, eyebrow, children, description) => (
  <main className="nm-public-shell">
    <Seo title={`${title} â€” N1MOX30`} description={description || `Official ${title} information for N1MOX30.`} />
...
export function PrivacyPage() {
  return shell("Privacy Policy", "LEGAL Â· PRIVACY", <>
    ...
    <div className="nm-public-callout">Last updated: September 2026 Â· Final policy owner and legal entity details must be verified before public launch.</div>
  </>, "N1MOX30 privacy framework covering account, creator, integration and support data.");
}

export function TermsPage() {
  return shell("Terms & Conditions", "LEGAL Â· TERMS", <>
...
export function CookiePage() {
  return shell("Cookie Policy", "LEGAL Â· COOKIES", <>
