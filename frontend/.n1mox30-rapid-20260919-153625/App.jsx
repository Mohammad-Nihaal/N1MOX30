...
import { Seo, NotFoundPage, HelpPage, ContactPage, PrivacyPage, TermsPage, CookiePage, DataRequestPage, AboutPage } from "./pages/PublicPages";
    ...
    <main className="landing-page">
      ...
      <section className="landing-hero">
        ...
        <div className="landing-hero-actions">
          <Link to="/register" className="landing-primary-btn">Build your first workflow <span>ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢</span></Link>
          <a href="#platform" className="landing-secondary-btn">See how it works</a>
        </div>
        <div className="landing-proof">
          <span>Research</span><i>Ãƒâ€šÃ‚Â·</i><span>Script</span><i>Ãƒâ€šÃ‚Â·</i><span>Voice</span><i>Ãƒâ€šÃ‚Â·</i>
          <span>Visuals</span><i>Ãƒâ€šÃ‚Â·</i><span>Publish</span>
        </div>
      </section>

      <section id="platform" className="landing-product">
        <div className="product-frame">
          <div className="product-topbar"><span>N1MOX30</span><span>Creator Command Center</span><span>ÃƒÂ¢Ã¢â‚¬â€Ã‚Â Live</span></div>
          <div className="product-grid">
            ...
            <div className="product-main">
              <div className="product-heading"><div><small>MONDAY Ãƒâ€šÃ‚Â· CREATOR OS</small><h3>Good morning.</h3></div><button>+ New workflow</button></div>
      ...
      <section id="workflow" className="landing-section">
        ...
        <div className="story-grid">
          ...
          ].map(([n,t,d]) => <article className="story-card" key={n}><span>{n}</span><h3>{t}</h3><p>{d}</p><b>ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â€</b></article>)}
        </div>
      </section>
      ...
      <section id="features" className="landing-section landing-dark">
        ...
        <div className="feature-grid">
          ...
          ].map(([t,d]) => <div className="feature-card" key={t}><span>ÃƒÂ¢Ã…â€œÃ‚Â¦</span><h3>{t}</h3><p>{d}</p></div>)}
        </div>
      </section>
      ...
      <section id="pricing" className="landing-pricing">
        ...
        <div className="price-card"><div><small>CREATOR WORKSPACE</small><h3>Start with the core OS</h3><p>Explore the complete workflow before committing to a larger production setup.</p></div><Link to="/register">Create account ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢</Link></div>
      </section>

      <section className="landing-final">
        <div className="section-kicker">YOUR NEXT VIDEO STARTS HERE</div>
        <h2>Stop managing<br />the process. <span>Run it.</span></h2>
        <Link to="/register" className="landing-primary-btn">Enter N1MOX30 <span>ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢</span></Link>
      </section>
      ...
      <footer className="landing-footer">
        ...
        <div className="footer-bottom"><span>Ãƒâ€šÃ‚Â© 2026 N1MOX30. All rights reserved.</span><span>Built for creators who ship.</span></div>
      </footer>
    </main>
  );
}
